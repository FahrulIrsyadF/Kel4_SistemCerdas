            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <h5>Berikut merupakan form untuk diagnosis penyakit Kanker Serviks berdasarkan risiko perilaku, dengan akurasi <strong> <?= substr($weight[0]['prosentase'], 0, 5) ?>%.</strong>
